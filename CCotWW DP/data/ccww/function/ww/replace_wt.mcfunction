...
data merge entity @s {Offers:{Recipes:[{buy:{id:"minecraft:emerald",count:16},buyB:{id:"minecraft:compass",count:1},sell:{id:"minecraft:filled_map",count:1},priceMultiplier:0.2f,maxUses:12}]}}

...
function animated_java:elevator/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'dab270d68055a7c89f956e405ea23d3dc6afb6f5a98a5e2829a4d39d2cc8d0dc'

...
function animated_java:stable_mirror/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '334c146aa20bfda3e10650939fe4ab48c8486f3bb858d7f634523e782041ee53'

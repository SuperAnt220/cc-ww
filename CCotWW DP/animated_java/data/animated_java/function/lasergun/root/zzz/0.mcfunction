...
function animated_java:lasergun/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'c3b1309f548e1dac31ca9626b8c9da65a8b80a2f0b934434e415557bce3ea26b'

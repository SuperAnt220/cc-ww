...
function animated_java:mindmap/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '4ba543d03c8ae2dc653d90ab99300cdcf98509dc29498947be608c26be360742'

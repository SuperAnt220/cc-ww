...
function animated_java:map_scanner/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'a68f60f08bfed077c6a147ff5b3a8acc534827ba99e541f3f64afb287b672605'

...
function animated_java:cccube/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'e927ec762ff98c34987cb882f9c7cebd0ab1f9287410946c53c508009bf8a3e7'
